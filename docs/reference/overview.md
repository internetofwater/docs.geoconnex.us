...
| **Expose data through standard APIs** | Leverage standard API patterns         | Follow [W3C spatial API recommendations](https://www.w3.org/TR/sdw-bp/#convenience-apis) to provide simplified data access, preferably using [OGC API standards](https://ogcapi.ogc.org).                                                         | [Building APIs with OGC standards](../access/index.md)                                                                     |
